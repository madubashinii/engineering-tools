-- ============================================================================
-- PILOT Migration 000004: Migrate legacy data to new schema for a single day
-- Target Date: 2026-07-10 (final catch-up day — today.
...
-- (Previously run: October 2024 through 2026-07-09 fully migrated.)
...
WHERE DATE(r.created_at) = '2026-07-10'
...
WHERE ra.asset_name IS NOT NULL
  ...
  AND DATE(ra.created_at) = '2026-07-10'
ON DUPLICATE KEY UPDATE
...
-- data actually ends (the filter allows through 2026-07-10, but rows only
...
-- you legacy data ends before 2026-07-10).
