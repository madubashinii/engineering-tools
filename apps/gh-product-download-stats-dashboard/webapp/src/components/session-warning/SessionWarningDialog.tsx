 ...
 * clicks Continue (resets the idle timer) or Logout (signs out). Never auto-dismisses.
 */
export default function SessionWarningDialog({
  ...
  return (
    <Dialog
      open={open}
      onClose={() => {
        // Blocked — user must choose an action.
      }}
      maxWidth="sm"
      fullWidth
      aria-labelledby="session-warning-title"
    >
      <DialogTitle id="session-warning-title">Are you still there?</DialogTitle>
      <DialogContent>
