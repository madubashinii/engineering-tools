...
// Header dropdown that switches the active Oxygen palette at runtime. The choice
// is persisted (localStorage) by ThemePreferenceProvider, so it survives reloads.
// Orthogonal to the light/dark ColorSchemeToggle beside it.
